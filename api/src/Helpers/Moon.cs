namespace api.Helpers
{
    public static class Moon
    {
        ...
        static Moon()
        {
            ...
            AllPhases = [.. Names.Select((t, i) => new Phase(t, period * i, period * (i + 1)))];
        }
        ...
        /// <param name="viewFromEarth">View from earth</param>
            ...
            DateTime moment)
        {
            ...
            public double DaysIntoCycle { get; set; } = daysIntoCycle;

            public Earth.Hemispheres Hemisphere { get; set; } = hemisphere;
            public DateTime Moment { get; } = moment;
